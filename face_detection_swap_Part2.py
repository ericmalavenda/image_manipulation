...
from face_detection_swap_Part1 import box_faces, newFaces, face_2_replace, swapFaces
...
def box_faces2(image, img):
    ...
    for (x,y,w,h) in face:
        ...
        '''
        bg_elliptical_face = cv2.ellipse(image,(math.floor(x+(w/2)),math.floor(y+(h/2))),(math.floor(h/3),math.floor(w/2)),0,0,360,1,-1)
