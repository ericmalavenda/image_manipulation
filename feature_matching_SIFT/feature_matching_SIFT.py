...
def findMatchesBetweenImages(image_1, image_2):
  ...
  # Referenced URL: http://opencv-python-tutroals.readthedocs.io/en/latest/
  # py_tutorials/py_feature2d/py_matcher/py_matcher.html
  ...
  # execution (as SIFT) on line#107] is provided as a bug workaround,
  # in accordance with the following issue reported in the opencv github repo:
